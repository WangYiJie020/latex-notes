...
\begin{theorem}
	...
	\[
		\boldsymbol{H}_{xy} = \boldsymbol{J} \boldsymbol{H}_{\xi\eta} \boldsymbol{J}^{T}
...
\begin{proof}
	...
	\[
		...
		= 
		\boldsymbol{J}
		\begin{bmatrix} u_{\xi\xi}\\ u_{\xi\eta} \end{bmatrix}
	\] 
	\[
		\begin{bmatrix} u_{\eta x} \\ u_{\eta y} \end{bmatrix}
		= 
		\boldsymbol{J}
		\begin{bmatrix} u_{\eta\xi}\\ u_{\eta\eta} \end{bmatrix}
	\] 
	...
	\] 
	where \[
		\boldsymbol{J}_x = \begin{bmatrix} \xi_{xx} & \eta_{xx}\\ \xi_{yx} & \eta_{yx} \end{bmatrix}
		\quad
		\boldsymbol{J}_y = \begin{bmatrix} \xi_{xy} & \eta_{xy}\\ \xi_{yy} & \eta_{yy} \end{bmatrix}
	\] 
...
\begin{aligned}
\begin{bmatrix}
\boldsymbol{J}_x \begin{bmatrix} u_\xi\\ u_\eta \end{bmatrix}
&
\boldsymbol{J}_y \begin{bmatrix} u_\xi\\ u_\eta \end{bmatrix}
\end{bmatrix}
&=
\begin{bmatrix}
u_\xi \xi_{xx} + u_\eta \eta_{xx}
...
\[
	...
	\begin{bmatrix} u_{\xi x} & u_{\xi y}\\ u_{\eta x} & u_{\eta y} \end{bmatrix}
	=
	\boldsymbol{J} \boldsymbol{H}_{\xi\eta} \boldsymbol{J}^{T}
\]
\end{proof}
